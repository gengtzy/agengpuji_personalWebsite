...
import Particles from "./Particles"; // Pastikan path import ini sesuai dengan lokasi file Particles.tsx
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Container absolute untuk menampung partikel di belakang konten */}
      <div className="absolute inset-0 z-0">
        <Particles
          particleColors={['#ffffff', '#05e448']} // Campuran Putih & Hijau Tema
          particleCount={200}
          particleSpread={10}
          speed={0.1}
      ...
      {/* Container Konten Utama (Diberi relative & z-10 agar di atas partikel) */}
      <div className="relative z-10 w-full">
        <Container className="flex flex-col-reverse md:flex-row items-center justify-between">
          ...
          >
            {/* Glow di belakang gambar tetap dipertahankan */}
